...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		int care = JOptionPane.showOptionDialog(null, "what do you want to do to make you pet happy", "pet happyness maker", 0, JOptionPane.INFORMATION_MESSAGE, null,
